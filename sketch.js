...
function start()
{
  ...
  button.position(width/2+900,height/2+500)
  input.position(width/2+900,height/2+400)
...
function setup()
 {
  ...
  coi0=createSprite(width-500,450,20,30);
  coi0.addImage(coin)
  coi0.scale=0.07
 
  coi1=createSprite(width-550,450,20,30);
  coi1.addImage(coin)
  coi1.scale=0.07
  
  coi2=createSprite(width-600,450,20,30);
  coi2.addImage(coin)
  coi2.scale=0.07 

  coi3=createSprite(width-650,450,20,30);
  coi3.addImage(coin)
  coi3.scale=0.07

  coi4=createSprite(width-700,450,20,30);
  coi4.addImage(coin)
  coi4.scale=0.07
   
  coi5=createSprite(width-750,450,20,30);
  coi5.addImage(coin)
  coi5.scale=0.07
  
  coi6=createSprite(width-800,450,20,30);
  coi6.addImage(coin)
  coi6.scale=0.07

  coi7=createSprite(width-850,450,20,30);
  coi7.addImage(coin)
  coi7.scale=0.07

  coi8=createSprite(width-900,450,20,30);
  coi8.addImage(coin)
  coi8.scale=0.07

  coi9=createSprite(width-950,450,20,30);
  coi9.addImage(coin)
  coi9.scale=0.07
...
function spawnObstacle()
{
  if(frameCount%120===0)
  {
    obstacle=createSprite(width,height-70,10,40)
...
function bricks1(y)
{
  for(var i=0;i<20;i++)
  {
    bri=createSprite((width-1000)+29*i,500+29,20,20);
    bri.addImage(brick)
    bri.scale=0.1
